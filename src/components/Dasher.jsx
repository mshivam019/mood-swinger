...
const Dasher = () => {
  ...
  console.log("1");
  return (
    <div className="flex bg-zinc-800 text-gray-400">
      <Sidebar
        onSidebarHide={() => {
...
function Sidebar({ onSidebarHide, showSidebar }) {
  ...
  return (
    <div
      className={clsx(
        "fixed inset-y-0 left-0 bg-zinc-900 w-full sm:w-20 xl:w-60 sm:flex flex-col z-10",
    ...
    >
      ...
      <div className="flex-shrink-0 overflow-hidden p-2">
        <div className="flex items-center h-full sm:justify-center xl:justify-start p-2 border-t border-solid border-gray-700">
...
function MenuItem({ item: { id, title, notifications }, onClick, selected }) {
  return (
    <div
      className={clsx(
        "w-full mt-6 flex items-center px-3 sm:px-0 xl:px-3 justify-start sm:justify-center xl:justify-start sm:mt-6 xl:mt-3 cursor-pointer border-r-2 border-solid",
        selected === id ? "border-white text-white" : "border-transparent hover:text-gray-300"
      )}
      onClick={() => onClick(id)}
    >
      <SidebarIcons id={id} />
    ...
    <div className="flex w-full">
      ...
      <div className=" h-screen flex-grow overflow-x-hidden overflow-auto flex flex-wrap content-start p-2">
        ...
        <div className="w-full p-2 lg:w-2/3">
          <div className="rounded-lg bg-zinc-900 sm:h-80 h-60">
            <Graph />
          </div>
        </div>
        <div className="w-full p-2 lg:w-1/3">
          <div className="rounded-lg bg-zinc-900 h-80">
            <TopCountries />
          </div>
        </div>
        ...
        <div className="w-full p-2 lg:w-1/3">
          <div className="rounded-lg bg-zinc-900 overflow-hidden h-80">
            <AddComponent />
          </div>
        </div>
      </div>
