    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
            <div className="text-center">
                <p className="text-lg font-medium dark:text-gray-900 text-gray-500 font-pj">2,157 people have said how good Rareblocks</p>
                <h2 className="mt-4 text-3xl font-bold dark:text-gray-900 text-gray-400 sm:text-4xl xl:text-5xl font-pj">Our happy clients say about us</h2>
            </div>
